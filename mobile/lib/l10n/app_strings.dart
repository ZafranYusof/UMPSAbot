class AppStrings {
  ...
  static final Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'register_subtitle': 'Join the UMPSA community',
      ...
      'logout_desc': 'You will need to login again to access the app.',

      // Admin
      'nav_admin': 'Admin',
      'admin_panel': 'Admin Panel',
      'admin_subtitle': 'Manage your chatbot system',
      'admin_upload_catalog': 'Upload Course Catalog',
      'admin_upload_catalog_desc': 'Upload or update course data for the chatbot',
      'admin_view_stats': 'View Statistics',
      'admin_view_stats_desc': 'View usage analytics and chat statistics',
      'admin_manage_users': 'Manage Users',
      'admin_manage_users_desc': 'View and manage registered users',
    ...
    'ms': {
      ...
      'register_subtitle': 'Sertai komuniti UMPSA',
      'create_account': 'Cipta Akaun',
      'email_hint': 'Alamat emel',
      'password_hint': 'Kata laluan',
      'confirm_password_hint': 'Sahkan kata laluan',
      'name_hint': 'Nama penuh',
      ...
      'logout_desc': 'Anda perlu log masuk semula untuk mengakses aplikasi.',

      // Admin
      'nav_admin': 'Admin',
      'admin_panel': 'Panel Admin',
      'admin_subtitle': 'Urus sistem chatbot anda',
      'admin_upload_catalog': 'Muat Naik Katalog Kursus',
      'admin_upload_catalog_desc': 'Muat naik atau kemas kini data kursus untuk chatbot',
      'admin_view_stats': 'Lihat Statistik',
      'admin_view_stats_desc': 'Lihat analitik penggunaan dan statistik sembang',
      'admin_manage_users': 'Urus Pengguna',
      'admin_manage_users_desc': 'Lihat dan urus pengguna berdaftar',
