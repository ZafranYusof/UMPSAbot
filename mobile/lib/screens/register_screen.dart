            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppStrings.get('register_subtitle', lang),
                    style: AppTheme.body(
                      fontSize: 14,
                  ...
                  TextFormField(
                    ...
                    style: AppTheme.body(color: AppColors.textPrimary),
                    decoration: InputDecoration(
                      hintText: AppStrings.get('confirm_password_hint', lang),
                      prefixIcon: const Icon(
                        Icons.lock_outline,
                        color: AppColors.textMuted,
                      ),
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return AppStrings.get('confirm_password_required', lang);
                      }
                      if (value != _passwordController.text) {
                        return AppStrings.get('passwords_not_match', lang);
                      }
                      return null;
                    },
                  ),
